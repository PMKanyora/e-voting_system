                ...
                if (($iopt)=="="){
                 ...
                 if ((qssession("students_multisearch_fd" . $i) != "")) {
                        ...
                        if ($qry_string == "") {
                            $qry_string = "search_fd" . $i . "=" . $ioldcon . urlencode(stripslashes($idata));
                            $qry_string .= "&multisearch_fd" . $i . "=" . qssession("students_multisearch_fd" . $i);
                            $filter_string = "(" . $fields[$i] . $conditionstr . " '" .$searchstartkey.  preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)). $searchendkey . "'";
                            $j = 0;
                            for ($j = 0; $j < count($searcharray); $j++) {
                                $searchindex = $searcharray[$j];
                                $filter_string .= " OR " . $fields[$searchindex]  . $conditionstr . " '" .$searchstartkey.  preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)). $searchendkey . "'";
                            }
                            $filter_string .= ")";
                        } else {
                            $qry_string .= "&search_fd" . $i . "=" . $ioldcon . urlencode(stripslashes($idata));
                            $qry_string .= "&multisearch_fd" . $i . "=" . qssession("students_multisearch_fd" . $i);
                            $filter_string .= " AND (" . $fields[$i]  . $conditionstr . " '" .$searchstartkey. preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . $searchendkey . "'";
                            $j = 0;
                            for ($j = 0; $j < count($searcharray); $j++) {
                                $searchindex = $searcharray[$j];
                                $filter_string .= " OR " . $fields[$searchindex]  . $conditionstr . " '" .$searchstartkey. preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . $searchendkey . "'";
                        ...
                        if ($qry_string == "") {
                            ...
                            $filter_string = $fields[$i]  . $conditionstr . " '" .$searchstartkey. preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . $searchendkey . "'";
                            if ($parammaster[$i] != ""){
                                 $filter_stringmaster = $parammaster[$i]  . $conditionstr . " '" .$searchstartkey. preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . $searchendkey . "'";
                            }
                        } else {
                            $qry_string .= "&search_fd" . $i . "=" . $ioldcon . urlencode(stripslashes($idata));
                            $filter_string .= $icon . $fields[$i]  . $conditionstr . " '" .$searchstartkey. preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . $searchendkey . "'";
                            if ($parammaster[$i] != ""){
                                 $filter_stringmaster .= $icon . $parammaster[$i]  . $conditionstr . " '" .$searchstartkey. preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . $searchendkey . "'";
                            }
                        }
                    }
            //==end $type_field == "type_string"
                ...
                if ((qssession("students_multisearch_fd" . $i) != "")) {
                    ...
                    if ($qry_string == "") {
                        $qry_string = "search_fd" . $i . "=" . $ioldcon . urlencode(stripslashes($idata));
                        $qry_string .= "&multisearch_fd" . $i . "=" . qssession("students_multisearch_fd" . $i);
                        $filter_string = "(" . $fields[$i] . " = '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                        $j = 0;
                        for ($j = 0; $j < count($searcharray); $j++) {
                            $searchindex = $searcharray[$j];
                            $filter_string .= " OR " . $fields[$searchindex] . " = '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                        }
                        $filter_string .= ")";
                    } else {
                        $qry_string .= "&search_fd" . $i . "=" . $ioldcon . urlencode(stripslashes($idata));
                        $qry_string .= "&multisearch_fd" . $i . "=" . qssession("students_multisearch_fd" . $i);
                        $filter_string .= " AND (" . $fields[$i] . " = '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                        $j = 0;
                        for ($j = 0; $j < count($searcharray); $j++) {
                            $searchindex = $searcharray[$j];
                            $filter_string .= " OR " . $fields[$searchindex] . " = '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                    ...
                    if ($qry_string == "") {
                        $qry_string = "search_fd" . $i . "=" . $ioldcon . urlencode(stripslashes($idata));
                        $filter_string = $fields[$i] . " like '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                        if ($parammaster[$i] != ""){
                            $filter_stringmaster = $parammaster[$i] . " like '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                        }
                    } else {
                        $qry_string .= "&search_fd" . $i . "=" . $ioldcon . urlencode(stripslashes($idata));
                        $filter_string .= $icon . $fields[$i] . " like '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                        if ($parammaster[$i] != ""){
                            $filter_stringmaster .= $icon . $parammaster[$i] . " like '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($irealdata)) . "'";
                        }
                    }
                }
...
&nbsp;<span id="Studid_caption_div">ID NO.</span>&nbsp;
...
&nbsp;<span id="Name_caption_div">First Name</span>&nbsp;
...
&nbsp;<span id="Course_caption_div">Middle Name</span>&nbsp;
...
&nbsp;<span id="Year_caption_div">Last Name</span>&nbsp;
...
&nbsp;<span id="Sec_caption_div">County</span>&nbsp;
...
&nbsp;<span id="Sy_caption_div">Y.O.B</span>&nbsp;
