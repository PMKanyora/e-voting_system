...
while ($i < mysql_num_fields($result)) {
    ...
    if ($meta) {
        if (qsrequest("currentrow_fd" .$i) != "") {
            if ($currentrow_sql == "") {
				// preg_replace('/[^a-zA-Z0-9\']/', '_', "There wouldn't be any")
                $currentrow_sql  = $fields[$i] . " = " . $quotedata . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes(qsrequest("currentrow_fd" . $i))) . $quotedata;
            } else {
                $currentrow_sql .= " and " .$fields[$i] . " = " . $quotedata . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes(qsrequest("currentrow_fd" . $i))) . $quotedata;
            }
...
// << END OF "before add string form field to sql (php)" [ITEMBEFADDTOSQLSTRING] [INLINE] [STOP] [SRV] [50275662-FD65-42E7-B3C6-C62E9D903743] [Update Students]
                ...
                $value_sql  .= "," . $quotechar . $field_name . $quotechar . " = '" . preg_replace ('/[^\p{L}\p{N}]/u', '_',stripslashes($idata)) . "'";
            }
			       else if($isEditables[$i] != 2) {
		             $value_sql .= "," . $quotechar . $field_name . $quotechar . " = null"; 
	           }
...
?>
  <tr>
<td colspan="2" class="ThRows">Current Voter Details</td>
</tr>
<?php
if ($err_string != "") {
    print "<tr>";
...
<tr>
<td class="ThRows">Middle Name</td>
<?php
$cellvalue = "";
...
if ((!isset($_GET["edit_fd3"])) && (!isset($_POST["edit_fd3"]))) {
    ...
    $cellvalue = "<input type=\"text\" name=\"edit_fd3\" value=\"" . qsreplace_html_quote(stripslashes($itemvalue)) . "\" size=\"30\"  maxlength=\"100\" >";
    if ($cellvalue == "") {
        $cellvalue = "&nbsp;";
    }
// >> START OF "Course -> on write tags" [PGITMPREDENDER001] [INLINE] [START] [SRVITEM] [D0552110-B8C5-4FC1-9627-1A8DBD03B973] [Course]
...
if ((!isset($_GET["edit_fd4"])) && (!isset($_POST["edit_fd4"]))) {
    ...
    $cellvalue = "<select name=\"add_fd4\" ><option value=\"Mombasa\"" . qscheckselected("Mombasa",$itemvalue,"selected") . ">Mombasa</option>
	<option value=\"Nandi\"" . qscheckselected("Nandi",$itemvalue,"selected") . ">Nandi</option>
	<option value=\"Baringo\"" . qscheckselected("Baringo",$itemvalue,"selected") . ">Baringo</option>
	<option value=\"Laikipia\"" . qscheckselected("Laikipia",$itemvalue,"selected") . ">Laikipia</option>
	<option value=\"Nakuru\"" . qscheckselected("Nakuru",$itemvalue,"selected") . ">Nakuru</option>
	<option value=\"Kajiado\"" . qscheckselected("Kajiado",$itemvalue,"selected") . ">Kajiado</option>
	<option value=\"Kericho\"" . qscheckselected("Kericho",$itemvalue,"selected") . ">Kericho</option>
	<option value=\"Bungoma\"" . qscheckselected("Bungoma",$itemvalue,"selected") . ">Bungoma</option>
	<option value=\"Bomet\"" . qscheckselected("Bomet",$itemvalue,"selected") . ">Bomet</option>
	<option value=\"Kakamega\"" . qscheckselected("Kakamega",$itemvalue,"selected") . ">Kakamega</option>
	<option value=\"Vihiga\"" . qscheckselected("Vihiga",$itemvalue,"selected") . ">Vihiga</option>
	<option value=\"Busia\"" . qscheckselected("Busia",$itemvalue,"selected") . ">Busia</option>
	<option value=\"Siaya\"" . qscheckselected("Siaya",$itemvalue,"selected") . ">Siaya</option>
	<option value=\"Kisumu\"" . qscheckselected("Kisumu",$itemvalue,"selected") . ">Kisumu</option>
	<option value=\"Homa Bay\"" . qscheckselected("Homa Bay",$itemvalue,"selected") . ">Homa Bay</option>
	<option value=\"Migori\"" . qscheckselected("Migori",$itemvalue,"selected") . ">Migori</option>
	<option value=\"Kisii\"" . qscheckselected("Kisii",$itemvalue,"selected") . ">Kisii</option>
	<option value=\"Nyamira\"" . qscheckselected("Nyamira",$itemvalue,"selected") . ">Nyamira</option>
	<option value=\"Nairobi\"" . qscheckselected("Nairobi",$itemvalue,"selected") . ">Nairobi</option>
	<option value=\"Makueni\"" . qscheckselected("Makueni",$itemvalue,"selected") . ">Makueni</option>
	<option value=\"Nyandarua\"" . qscheckselected("Nyandarua",$itemvalue,"selected") . ">Nyandarua</option>
	<option value=\"Nyeri\"" . qscheckselected("Nyeri",$itemvalue,"selected") . ">Nyeri</option>
	<option value=\"Kirinyaga\"" . qscheckselected("Kirinyaga",$itemvalue,"selected") . ">Kirinyaga</option>
	<option value=\"Murang'a\"" . qscheckselected("Murang'a",$itemvalue,"selected") . ">Murang'a</option>
	<option value=\"Kiambu\"" . qscheckselected("Kiambu",$itemvalue,"selected") . ">Kiambu</option>
	<option value=\"Turkana\"" . qscheckselected("Turkana",$itemvalue,"selected") . ">Turkana</option>
	<option value=\"West Pokot\"" . qscheckselected("West Pokot",$itemvalue,"selected") . ">West Pokot</option>
	<option value=\"Samburu\"" . qscheckselected("Samburu",$itemvalue,"selected") . ">Samburu</option>
	<option value=\"Trans-Nzoia\"" . qscheckselected("Trans-Nzoia",$itemvalue,"selected") . ">Trans-Nzoia</option>
	<option value=\"Uasin Gishu\"" . qscheckselected("Uasin Gishu",$itemvalue,"selected") . ">Uasin Gishu</option>
	<option value=\"Elgeyo-Marakwet\"" . qscheckselected("Elgeyo-Marakwet",$itemvalue,"selected") . ">Elgeyo-Marakwet</option>
	<option value=\"Nandi\"" . qscheckselected("Nandi",$itemvalue,"selected") . ">Nandi</option>
	<option value=\"Baringo\"" . qscheckselected("Baringo",$itemvalue,"selected") . ">Baringo</option>
	<option value=\"Nakuru\"" . qscheckselected("Nakuru",$itemvalue,"selected") . ">Nakuru</option>
	<option value=\"kwale\"" . qscheckselected("kwale",$itemvalue,"selected") . ">kwale</option>
	<option value=\"Kilifi\"" . qscheckselected("Kilifi",$itemvalue,"selected") . ">Kilifi</option>
	<option value=\"Tana River\"" . qscheckselected("Tana River",$itemvalue,"selected") . ">Tana River\</option>
	<option value=\"Lamu\"" . qscheckselected("Lamu",$itemvalue,"selected") . ">Lamu</option>
	<option value=\"Taita Taveta\"" . qscheckselected("Taita Taveta",$itemvalue,"selected") . ">Taita Taveta</option>
	<option value=\"Garisa\"" . qscheckselected("Garisa",$itemvalue,"selected") . ">Garisa</option>
	<option value=\"Wajir\"" . qscheckselected("Wajir",$itemvalue,"selected") . ">Wajir</option>
	<option value=\"Mandera\"" . qscheckselected("Mandera",$itemvalue,"selected") . ">Mandera\</option>
	<option value=\"Marsabit\"" . qscheckselected("Marsabit",$itemvalue,"selected") . ">Marsabit</option>
	<option value=\"Isiolo\"" . qscheckselected("Isiolo",$itemvalue,"selected") . ">Isiolo\</option>
	<option value=\"Meru\"" . qscheckselected("Meru",$itemvalue,"selected") . ">Meru</option>
	<option value=\"Tharaka Nithi\"" . qscheckselected("Tharaka Nithi",$itemvalue,"selected") . ">Tharaka Nithi</option>
	<option value=\"Embu\"" . qscheckselected("Embu",$itemvalue,"selected") . ">Embu</option>
	<option value=\"Kitui\"" . qscheckselected("Kitui",$itemvalue,"selected") . ">Kitui</option>
	<option value=\"Machakos\"" . qscheckselected("Machakos",$itemvalue,"selected") . ">Machakos</option>
	<option value=\"Narok\"" . qscheckselected("Narok",$itemvalue,"selected") . ">Narok</option></select>";
    if ($cellvalue == "") {
        $cellvalue = "&nbsp;";
    }
